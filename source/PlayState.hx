...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if(Paths.currentModDirectory != SUtil.getPath() + null && Paths.currentModDirectory.length > 0)
		...
		timeTxt.setFormat(Paths.font("Bronx.otf"), 32, FlxColor.BLACK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
		...
		scoreTxt.setFormat(Paths.font("Bronx.otf"), 20, FlxColor.BLACK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
		...
		botplayTxt.setFormat(Paths.font("Bronx.otf"), 32, FlxColor.BLACK, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.WHITE);
